...
3. Has options to sort the list by name, country, or date of birth, as well as to delete rows individually or restore the list to its initial state.
4. More features that I will add over time

The app uses a useContext to pass properties (e.g., the list of users) from the main component to its children, avoiding unnecessary prop drilling.
